"""
Django base settings for Cardápio Online.

Shared configuration for all environments.
Environment-specific settings in development.py / production.py.
"""
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Cardápio Online API',
    'DESCRIPTION': 'API documentation for Cardápio Online multi-tenant platform',
    'VERSION': '1.0.0',
